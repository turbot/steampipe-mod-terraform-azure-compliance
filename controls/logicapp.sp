locals {
  logicapp_compliance_common_tags = merge(local.compliance_common_tags, {
    service = "logicapp"
  })
}
...
benchmark "logicapp" {
  ...
  tags = local.logicapp_compliance_common_tags
}
...
control "logic_app_workflow_logging_enabled" {
  ...
  tags = merge(local.logicapp_compliance_common_tags, {

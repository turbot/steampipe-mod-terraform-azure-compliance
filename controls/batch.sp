locals {
  batch_compliance_common_tags = merge(local.terraform_azure_compliance_common_tags, {
    service = "Azure/Batch"
  })
}
...
benchmark "batch" {
  title       = "Batch"
  description = "This benchmark provides a set of controls that detect Terraform Azure Batch resources deviating from security best practices."
